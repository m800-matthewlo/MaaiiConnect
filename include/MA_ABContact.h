...
#define MAX_NUMBER_OF_PHONES_PER_CONTACT 10

@interface MA_ABContact : NSObject
{
	ABRecordRef record;
}
...
+ (id) contactWithRecordID: (ABRecordID) recordID inAddressBook:(ABAddressBookRef) addressBook;
